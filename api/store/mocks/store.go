...
import (
	...
	auth "github.com/shellhub-io/shellhub/pkg/api/auth"
...
func (_m *Store) NamespaceAddMember(ctx context.Context, tenantID string, memberID string, memberRole auth.Role) (*models.Namespace, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, auth.Role) (*models.Namespace, error)); ok {
		return rf(ctx, tenantID, memberID, memberRole)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, auth.Role) *models.Namespace); ok {
...
func (_m *Store) NamespaceEditMember(ctx context.Context, tenantID string, memberID string, memberNewRole auth.Role) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, auth.Role) error); ok {
